    ...
    <footer className="bg-gray-900 text-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {/* Brand */}
          <div>
            <h3 className="text-2xl font-bold mb-6">ShopMart</h3>
            <p className="text-gray-300 mb-6">
              Your ultimate destination for quality products and exclusive deals. Shop smart, save more.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li><Link href="/deals"><a className="text-gray-300 hover:text-white transition-colors">Deals</a></Link></li>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li><Link href="/help"><a className="text-gray-300 hover:text-white transition-colors">Help Center</a></Link></li>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li><a href="#" className="text-gray-300 hover:text-white transition-colors">Security Policy</a></li>
        ...
        <div className="border-t border-gray-700 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-300">&copy; 2024 ShopMart. All rights reserved.</p>
