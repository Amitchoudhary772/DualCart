              ...
              <Card className="sticky top-24">
                ...
                <CardContent className="space-y-4">
                  <div className="space-y-3">
                    {cartItems.map((item) => (
                      <div key={item.id} className="flex items-center space-x-3">
                        ...
                        <p className="font-medium">₹{(parseFloat(item.product.price) * (item.quantity || 0)).toLocaleString()}</p>
                      </div>
                    ))}
                  </div>
                  ...
                  <form onSubmit={handleSubmit}>
                    ...
                    >
                      {placeOrderMutation.isPending ? "Processing..." : `Place Order - ₹${(total * 1.18).toLocaleString()}`}
                    </Button>
                  </form>
